...
FLOW_ID="${FLOW_ID:-build_status_notifications}"
PAYLOAD_FILE="${PAYLOAD_FILE:-$ROOT/samples/payloads/build_status_event.json}"
TENANT="${TENANT:-dev}"
...
echo "Replaying build status payload into flow '$FLOW_ID'"
